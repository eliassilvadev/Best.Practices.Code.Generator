...
namespace BestPracticesCodeGenerator
{
    public static class CreateUseCaseFactory
    {
        ...
        private static string CreateUseCaseClass(string fileContent, string originalClassName, IList<PropertyInfo> properties)
        {
            ...
            content.AppendLine(string.Concat("\tpublic class ", newClassName, $" : CommandUseCase<Create{originalClassName}Input, Create{originalClassName}Output>"));
        ...
        {
            content.AppendLine($"\t\tpublic async Task<UseCaseOutput<Create{className}Output>> InternalExecuteAsync(Create{className}Input input)");
            content.AppendLine("\t\t{");
