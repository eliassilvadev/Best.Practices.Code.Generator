...
namespace BestPracticesCodeGenerator
{
    public static class ControllerFactory
    {
            ...
            bool generateGetUseCase)
        {
            ...
            return CreateUseCaseClass(fileContent, originalClassName, classProperties, generateCreateUseCase, generateUpdateUseCase, generateDeleteUseCase, generateGetUseCase, filePath);
        }
        ...
        private static void GenerateControllerConstructor(StringBuilder content, string originalClassName, string newClassName, bool generateCreateUseCase, bool generateUpdateUseCase, bool generateDeleteUseCase, bool generateGetUseCase)
        {
            ...
            if (generateGetUseCase)
            {
                ...
                content.AppendLine($"\t\t\tGetPaginatedResultsUseCase<ICqrsQueryProvider<{originalClassName}Output>, {originalClassName}Output> getPaginated{originalClassName}UseCase)");
            }
            ...
            bool generateGetUseCase)
        {
            ...
            if (generateGetUseCase)
            {
                ...
                content.AppendLine();
                content.AppendLine($"\t\t[HttpPost]");
                content.AppendLine($"\t\t[ProducesResponseType(typeof(IEnumerable<{originalClassName}Output>), StatusCodes.Status200OK)]");
        ...
        private static void GeneratePrivateVariables(StringBuilder content, string originalClassName, bool generateCreateUseCase, bool generateUpdateUseCase, bool generateDeleteUseCase, bool generateGetUseCase)
        {
            ...
            if (generateGetUseCase)
            {
                ...
                content.AppendLine($"\t\tprivate readonly GetPaginatedResultsUseCase<ICqrsQueryProvider<{originalClassName}Output>, {originalClassName}Output> _getPaginated{originalClassName}UseCase;");
            }
